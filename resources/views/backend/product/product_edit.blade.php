...
@section('PageTitle', 'Modifica prodotto')
@section('plugins')
                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="mb-3">
                                    ...
                                    <input name="product_name" type="text" class="form-control" id="inputProductTitle"
                                           placeholder="Inserisci il titolo del prodotto" required value="{{$data->product_name}}">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Tag base</label>
                                ...
                                <div class="mb-3">
                                    <label  class="form-label">Immagini prodotto</label>
                        ...
                        <div class="col-lg-4">
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="inputProductType" class="form-label">Marca prodotto</label>
                                    ...
                                    <div class="col-12">
                                        <label for="inputVendor" class="form-label">Categoria prodotto</label>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#product_form').on('submit', function(event){
                ...
                $.ajax({
                    url: "{{route('Venditore-product-update', ['id' => $data->product_id])}}",
                    method: 'POST',
